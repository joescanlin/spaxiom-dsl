...
class RandomSensor(Sensor):
    ...
    def __init__(self, name: str, location: Tuple[float, float, float], metadata: Optional[Dict[str, Any]] = None):
        super().__init__(name=name, sensor_type="random", location=location, metadata=metadata)
