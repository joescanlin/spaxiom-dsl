...
async def main():
    ...
    try:
        ...
        print(f"After door open - door_open: {door_open.evaluate()}, door_closed: {door_closed.evaluate()}")
        ...
        door.close()
        await asyncio.sleep(0.1)  # Add a small delay to ensure condition is evaluated
        print(f"After door close - door_open: {door_open.evaluate()}, door_closed: {door_closed.evaluate()}")
        ...
        if entry_detected:
            ...
            print("Debug info: If all conditions evaluated correctly but the sequence wasn't detected,")
